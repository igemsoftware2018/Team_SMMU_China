...
% Last Modified by GUIDE v2.5 12-Oct-2018 12:26:17
...
%xlsName=strcat(SaveFolder, '\CaSparkData_', sampleName ,'.xls')
...
%     xlswrite([xlsName],{'ms'},1,'A1');
%     xlswrite([xlsName],xxSpark,1,'A2');
...
%     sheet=1;
%     xlsRange=[excelcolindx(columnN+1),'1'];
%     xlswrite(xlsName,k,sheet,xlsRange);
%     xlsRange=[excelcolindx(columnN+1),'2'];
%     xlswrite(xlsName,aav,sheet,xlsRange);
...
% --------------------------------------------------------------------
function nmuCalTrans_Callback(hObject, eventdata, handles)
% hObject    handle to nmuCalTrans (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --------------------------------------------------------------------
function mnuCalcontent_Callback(hObject, eventdata, handles)
% hObject    handle to mnuCalcontent (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
